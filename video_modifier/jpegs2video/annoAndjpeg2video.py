...
parser.add_argument('-x', '--xmldir',  dest='xmldir',  help='xml directory', required=True)
...
# open cv 3.1 has no "cv2.cv, cv2.CV_AA" -> please define CV_AA.
#    cv2.putText(im, text, (xmin + 4, ymin - 4), fontface, fontsize, (255,255,255), fonttick, cv2.CV_AA)
#    CV_AA = 16 # add line
#    cv2.putText(im, text, (xmin + 4, ymin - 4), fontface, fontsize, (255,255,255), fonttick, CV_AA) # add line
    cv2.putText(im, text, (xmin + 4, ymin - 4), fontface, fontsize, (255,255,255), fonttick)
    return im
