...
################################################
## multi filter complex example 1
...
################################################
## multi filter complex example 2
## sample : インターレース解除し、字幕合成
## -i bottom.mp4 -filter_complex "[0:v]yadif[layler1],[layer1][0:s:0]overlay[v];" -map "[v]" 
################################################
